  ...
  export default {
    ...
    methods: {
      ...
      init: function() {
        ...
        let url = 'api/sourceEdit/problemSource/getSourceList'
      ...
      deleteSourceReq() {
        this.$confirm(`您确定要删除您当前所勾选的这` + this.idList.length + `条数据吗？`, `提示`, {
      ...
      handleSubmitAll() {
        this.$confirm(`您确定要提交您当前所勾选的这` + this.idList.length + `条数据吗？`, `提示`, {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(() => {
